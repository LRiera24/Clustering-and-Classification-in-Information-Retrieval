...
%potencial para mejorar la eficiencia de la recuperación, para mejorar la eficacia de la recuperación
%proporciona una alternativa a la recuperación booleana o de mejor coincidencia. 
%
%
	...
	\subsection{K Nearest Neighbor}
		...
		\subsection{Ventajas}
				\begin{itemize}
					...
					\item La salida suele ser m\'as precisa que en el ML no supervisado.
					\item El proceso es f\'acil de comprender (las acciones de la m\'aquina se comprenden con precisi\'on a diferencia del no supervisado).
					\item Es m\'as facil de trabajar con el no supervisado (en t\'erminos de implementaci\'on).
		...
		\subsection{Desventajas}
				\begin{itemize}
					...
					\item Por lo general no se resuelven tareas m\'as complejas como en el ML no supervisado.
