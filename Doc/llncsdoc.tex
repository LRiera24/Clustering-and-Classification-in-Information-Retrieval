...
-https://aprendeia.com/ventajas-y-desventajas-de-los-algoritmos-de-clasificacion-machine-learning/		
		...
		\begin{itemize}
			...
			\item Ver si hay alguna forma mejor de escribir los algoritmos que hasta ahora estan horribles. Quizas mediante el uso de fotos.
			\item En clasificacion solo faltan las ventajas y desventajas que si no da tiempo se pone eso mismo que escribi ahi
		\end{itemize}
		\color{black}
...
\color{red} Leer: https://futuroelectrico.com/aprendizaje-supervisado/ \color{black}
